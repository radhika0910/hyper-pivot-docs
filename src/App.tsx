...
const catIcons: Record<string, React.ReactNode> = {
  ...
  toggle_on: <ToggleOnIcon fontSize="small" />,
  view_list: <ViewListIcon fontSize="small" />,
  code: <CodeIcon fontSize="small" />,
};

const Code: React.FC<{ children: string; color?: string }> = ({
  children,
  color = "#06B6D4",
}) => (
  <Box
...
const ApiCard: React.FC<{ cat: PropCategory }> = ({ cat }) => {
  ...
  return (
    <Paper
      elevation={0}
      sx={{ mb: 3, overflow: "hidden", animation: "slideUp 0.5s ease-out" }}
    >
      <Box
                ...
                >
                  ...
                  >
                    <Chip
                      ...
                      size="small"
                      sx={{
                        backgroundColor: p.required
                          ? "rgba(124,58,237,0.15)"
                          : "rgba(255,255,255,0.05)",
                        color: p.required ? "#A78BFA" : "text.primary",
                        fontWeight: 600,
                        borderRadius: 1,
  ...
  const drawer = (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <Toolbar sx={{ py: 3 }}>
        ...
        >
          <img src={logoUrl} alt="Hyper Pivot Logo" loading="lazy" />
        </Box>
        <Box>
          <Typography
            variant="h6"
            sx={{ fontWeight: 800, letterSpacing: 0.5, lineHeight: 1.2 }}
          >
            Hyper Pivot
          </Typography>
            ...
            >
              ...
              <ListItemText
                ...
                primaryTypographyProps={{
                  ...
                  fontSize: "0.9rem",
                  color:
                    section === item.id ? "text.primary" : "text.secondary",
                }}
              />
            </ListItemButton>
          </ListItem>
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      <AppBar
        position="fixed"
        elevation={0}
        sx={{ width: { md: `calc(100% - ${DW}px)` }, ml: { md: `${DW}px` } }}
      >
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Tooltip title={`Switch to ${isDark ? "light" : "dark"} mode`}>
            ...
            >
              {isDark ? (
                <LightModeIcon sx={{ color: "#EAB308", fontSize: 20 }} />
              ) : (
                <DarkModeIcon sx={{ color: "#7C3AED", fontSize: 20 }} />
              )}
            </IconButton>
          </Tooltip>
          <Chip
            label={`${totalProps} Props`}
            size="small"
            sx={{
            ...
            <Box sx={{ mb: 6, position: "relative" }}>
              <Box
                sx={{
                  ...
                  width: 350,
                  height: 350,
                  background: `radial-gradient(circle, ${isDark ? "rgba(124,58,237,0.12)" : "rgba(124,58,237,0.06)"} 0%, transparent 70%)`,
              ...
              >
                {section === "demo" &&
                  "Drag fields to dynamically pivot your data. Built for modern enterprise React apps."}
                {section === "installation" &&
                  "Add Hyper Pivot to your project in seconds. Zero bloat, perfect MUI integration."}
                {section === "customize" &&
                  "Full theme & color control. Make it yours with a few lines of config."}
                {section === "api" &&
                  `Explore all ${totalProps} props across ${propCategories.length} categories. Fully typed.`}
              </Typography>
            </Box>
            ...
            {section === "demo" && (
              ...
              >
                ...
                <Box sx={{ flexGrow: 1, overflow: "hidden", p: 1 }}>
                  <PivotGrid
                    data={sampleData}
                    initialRows={["Region", "Country"]}
                    initialColumns={["Category"]}
                    initialValues={["Sales"]}
            ...
            {section === "installation" && (
              <Box>
                ...
                >
                  ...
                  <Code>
                    npm install hyper-pivot @mui/material @emotion/react
                    @emotion/styled
                  </Code>
                </Paper>
                <Paper
              ...
              <Box>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Switch between light, dark, or auto (inherits from your MUI
                    ThemeProvider).
                  </Typography>
...
/>`}</Code>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Override any color token to match your brand identity.
                  </Typography>
                  <Code color="#E2E8F0">{`<PivotGrid
  data={myData}
  colors={{
...
/>`}</Code>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Position the sidebar, toggle sections, and control column
                    widths.
                  </Typography>
                  <Code color="#E2E8F0">{`<PivotGrid
  data={myData}
...
/>`}</Code>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Toggle every feature independently. Ship exactly what your
                    users need.
                  </Typography>
                  <Code color="#E2E8F0">{`<PivotGrid
  data={myData}
